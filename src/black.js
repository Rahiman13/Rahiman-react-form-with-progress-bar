                        ...
                        <div className="form-step">
                            ...
                            {addMoreClicked > 0 && (
                                <>
                                    ...
                                    <div className="input-group">
                                        <input type="text" name="tenthPercentage" placeholder="10th Percentage" value={formData.tenthPercentage} onChange={handleChange} required />
                                    </div>
                                    <div className="input-group">
                                        <input type="text" name="tenthPassOutYear" placeholder="10th Pass Out Year" value={formData.tenthPassOutYear} onChange={handleChange} required />
                                    </div>
                                    <div className="input-group">
                                    ...
                                    <div className="input-group">
                                        <input type="text" name="interPercentage" placeholder="Intermediate Percentage" value={formData.interPercentage} onChange={handleChange} required />
                                    </div>
                                    <div className="input-group">
                                        <input type="text" name="interPassOutYear" placeholder="Intermediate Pass Out Year" value={formData.interPassOutYear} onChange={handleChange} required />
                                    </div>
                                    {addMoreClicked < 2 && (
                                        <button type="button" onClick={handleAddMore}>Add More</button>
                                    )}
